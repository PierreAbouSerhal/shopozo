<?php
    ...
    $sqlVerif = 'SELECT COUNT(*) AS rowNbr FROM shoppingCarts WHERE userId = '.$user["userId"].' AND productId = '.$prodId;
    ...
    $sqlDelete = 'DELETE FROM shoppingCarts WHERE userId = '.$user["userId"].' AND productId = '.$prodId;
