<?php
    ...
    $sqlVerif = 'SELECT COUNT(*) AS rowNbr FROM history WHERE userId = '.$user["userId"].' AND productId = '.$prodId;
    ...
    $sqlDelete = 'DELETE FROM history WHERE userId = '.$user["userId"].' AND productId = '.$prodId;
